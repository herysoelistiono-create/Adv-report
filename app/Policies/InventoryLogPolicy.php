...
class InventoryLogPolicy
{
     ...
     */
    public function view(User $user, InventoryLog $item): bool
    {
     ...
     */
    public function update(User $user, InventoryLog $item): bool
    {
     ...
     */
    protected function canAccess(User $user, InventoryLog $item, string $action): bool
    {
        switch ($user->role) {
